...
def createScene(root_node):
    ...
    root_node.addObject('CCDTightInclusionIntersection', name="Intersection", continuousCollisionType="FreeMotion",maxIterations=1000, contactDistance=0.0)
    ...
    Liver.addObject('MeshGmshLoader', name="meshLoader", filename="mesh/liver.msh", scale3d=[0.2, 0.2, 0.2], rotation=[0, 180, -45], translation=[15.2, 15.65, 15.64])
    ...
    Liver.addObject('MechanicalObject', name="mstate", template="Vec3d", position="@Container.position", velocity=[-3,-3,-3]*181)
    ...
    PlateMecha.addObject('MechanicalObject', name="mstate", template="Vec3d", position="@Container.position", velocity=[10,10,10]*300)
    ...
    surface.addObject('TriangleSetTopologyModifier', name="Modifier")
    surface.addObject('MechanicalObject', name="dofs", rest_position="@../mstate.rest_position")
    surface.addObject('TriangleCollisionModel', name="Collision", contactDistance=0.000001, color=[0.94117647058824, 0.93725490196078, 0.89411764705882, 1])
    surface.addObject('IdentityMapping', name="SurfaceMapping")
